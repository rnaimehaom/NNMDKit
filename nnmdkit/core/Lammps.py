...
class Lammps:
    ...
    def write_input(self, output_dir):
        ...
        with open(output_dir + '/' + settings_fname, 'w') as f:
            ...
            f.write('{:<15} * * {} {}\n'.format('pair_coeff', self.NN_POTENTIAL, self.element))
            f.write('\n')
            f.write('{:<15} {} bin\n'.format('neighbor', self.neighbor_skin))
            f.write('{:<15} delay 0 every {} check yes\n'.format('neigh_modify', self.neighbor_every))
            f.write('\n')
        ...
        with open(output_dir + '/' + lmp_input_fname, 'w') as f:
            ...
            if hasattr(self, 'min_kwargs'):
                ...
                f.write('{:<15} {}\n'.format('min_style', self.min_kwargs['min_style']))
                f.write('{:<15} {} {} {} {}\n'.format('minimize', 
                                                      self.min_kwargs['etol'],
                                                      self.min_kwargs['ftol'],
                                                      self.min_kwargs['maxiter'],
            ...
            if hasattr(self, 'Tg_kwargs'):
                ...
                f.write('{:<15} loop\n'.format('label'))
                f.write('{:<15} a loop {}\n'.format('variable', int((self.Tg_kwargs['Tinit']-self.Tg_kwargs['Tfinal'])/self.Tg_kwargs['Tinterval']+1)))
                f.write('{:<15} b equal {}-{}*($a-1)\n'.format('variable', self.Tg_kwargs['Tinit'], self.Tg_kwargs['Tinterval']))
                f.write('{:<15} fNPT all npt temp $b $b {} iso {} {} {}\n'.format('fix', self.Tg_kwargs['Tdamp'], 
                                                                                  self.Tg_kwargs['pressure'], 
                                                                                  self.Tg_kwargs['pressure'], 
